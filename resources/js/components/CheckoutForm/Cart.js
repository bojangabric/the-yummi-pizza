...
const Cart = props => {
  return (
    <div className="ml-12">
      <div className="uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Your cart</div>
      <div className="p-6 form-input">
        {props.cart && props.cart.length < 1 ? (
          <div className="text-gray-600 text-center flex flex-col items-center">
            <div className="mb-2">You currently have no items in cart!</div>
            ...
            <a href="/" className="w-full bg-yellow-400 text-yellow-800 mt-6 flex justify-center px-6 py-2 rounded">
              Go back and select a pizza!
            </a>
          </div>
        ) : (
